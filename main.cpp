...
int main()
{
    ...
    cout << "\tEnter [1] to Encrypt AND Decrypt your own text" << endl;
    cout << "\tEnter [2] to Decrypt plain text file" << endl;
    ...
    { // ENCRYPTION //
        ...
        if (choice == 1)
        {
            ...
            char temp1 = encrytiontext.at(n); // store the value to decryption just in case
